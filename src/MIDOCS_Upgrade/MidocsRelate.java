...
public class MidocsRelate {
	public static void main(String args[]) throws DfException
	{
		...
		String query=" select r_object_id from mi_response where object_name='US-XIN-S009735'";
		...
		while(col.next())		
		{
			try
			{
				...
				if(document.isImmutable()){
					...
					relationObject.setChildId(new DfId("0902b7208035971a"));
					relationObject.setChildLabel("1.3");
					relationObject.save();
