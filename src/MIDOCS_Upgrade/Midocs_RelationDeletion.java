...
public class Midocs_RelationDeletion {
	public static void main(String args[]) throws DfException
	{
		...
		String query=" select r_object_id from mi_response where object_name='US-BET-S009101'";
		...
		while(col.next())		
		{
			try
			{
				...
				if(document.isImmutable()){
					...
					IDfRelation relationObject =(IDfRelation) session.getObjectByQualification("dm_relation where parent_id = '"+object_id+"' and child_id='0902b7208032f927'");
					if(relationObject!=null){
					System.out.println("document saved "+relationObject);
					...
					//relationObject.setChildId(new DfId("0902b7208037b21f"));
					//relationObject.setChildLabel("1.1");
					//relationObject.save();
					System.out.println("document saved "+relationObject);
					//}
				c++;
